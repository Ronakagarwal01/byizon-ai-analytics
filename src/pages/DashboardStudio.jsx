...
export default function DashboardStudio() {
  ...
  const studioInitials = workspaceInitials(workspaceUser);
  const studioProfileName = workspaceUser.displayName || 'Workspace';
  ...
  return (
    <div className={`dashboard-studio byizon-studio-fixed studio-comfortable studio-theme-${theme}`}>
      <header className="studio-topbar">
        ...
        <div className="studio-topbar-actions">
          ...
          <div className="studio-animated-profile" title={`${studioProfileName} Workspace`}><span>{studioInitials}</span><i /></div>
        </div>
      </header>
