...
function readChartTheme() {
  ...
  const grid = readToken('--chart-grid', 'rgba(37, 99, 235, 0.16)');
  ...
  const primary = readToken('--chart-primary', readToken('--blue-500', '#3b82f6'));
  const secondary = readToken('--chart-secondary', readToken('--blue-400', '#60a5fa'));
