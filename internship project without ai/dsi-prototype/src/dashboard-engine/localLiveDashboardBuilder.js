...
const PALETTES = [
  { name: 'Indigo SaaS', primary: '#4f46e5', accent: '#06b6d4', mode: 'light' },
  { name: 'Emerald Finance', primary: '#059669', accent: '#2563eb', mode: 'light' },
  { name: 'Ocean Dark', primary: '#38bdf8', accent: '#8b5cf6', mode: 'dark' },
  { name: 'Violet Analytics', primary: '#7c3aed', accent: '#14b8a6', mode: 'dark' },
  { name: 'Blue Executive', primary: '#2563eb', accent: '#10b981', mode: 'light' },
];
