...
import { Bell, Check, Copy, Database, ExternalLink, Globe2, Loader2, Menu, Moon, Paintbrush, Plus, Sparkles, Sun, X } from 'lucide-react';
    ...
    <>
      <header className="workspace-topbar" aria-label="Workspace actions">
        ...
        <div className="workspace-topbar-actions">
          <button
            className="topbar-create-dashboard"
            type="button"
            onClick={openBuilder}
          >
            <Plus size={15} />
        ...
        <button className="topbar-connect-data" type="button" onClick={connectData}>
          <Database size={14} />
