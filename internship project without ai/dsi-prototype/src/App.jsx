...
function AppVoiceAssistant() {
  ...
  const shouldHideVoiceDock = ["/landing", "/privacy", "/terms", "/voice", "/signup", "/register", "/login", "/verify-email", "/onboarding", "/onboarding/company", "/onboarding/team", "/onboarding/data-source", "/onboarding/ai-workspace", "/onboarding/complete"].includes(pathname);
  return shouldHideVoiceDock ? null : <GlobalVoiceAssistant />;
}
